...
\textbf{需要提交前补充：}根据课程要求，最终报告中还应填写代码所在的 public GitHub repo 链接，以及训练权重的网盘下载链接。当前占位如下：

\begin{itemize}
    \item GitHub repo：\url{https://github.com/your-name/your-repo}
    \item 模型权重网盘链接：\url{https://your-cloud-drive-link}
\end{itemize}
